...
plt.xlabel(r'Time (s)',fontsize = '20')
plt.ylabel(r'Residual (m s$^{-3}$)', fontsize = '20')
plt.tick_params(axis='x', labelsize=20)
plt.tick_params(axis='y', labelsize=20)
plt.grid()
...
#plt.ylabel(r'$-\phi u_z^s \Delta x \Delta y$ (m$^{3}$ s$^{-1}$)', fontsize = '20')
#plt.tick_params(axis='x', labelsize=20)
#plt.tick_params(axis='y', labelsize=20)
#plt.grid()
...
ax2.plot(simu4.time[:-1], simu4.phi_dzbed_sur_dt + simu4.intdVolPhi_sur_dt + simu4.intSlat_PindS + simu4.intS_PindS + simu4.intS2_PindS + simu4.intStop_PindS, color = 'r', label = r'\textcircled{1}+\textcircled{2}+\textcircled{3}+\textcircled{4}+\textcircled{5}')
...
ax3.legend(prop={"size": 17}, loc = "lower right")
